      ...
      <section className="service-hero">
        ...
        <div className="service-hero__content">
          ...
          <div className="service-hero__cta-row">
            <Link href="/contact" className="service-hero__btn-primary">
              Book Appointment
            </Link>
          </div>
        </div>
        ...
        <div className="why-container">
          ...
          <div className="why-content">
            ...
            <div className="why-service-block">
              ...
              {service.detailedHtml ? (
                <div className="why-service-body prose max-w-none text-gray-600" dangerouslySetInnerHTML={{ __html: service.detailedHtml }} />
              ) : (
          ...
          <div className="why-feature-grid">
            {(service.features || DEFAULT_FEATURES).map((feature, idx, arr) => (
              <div key={idx} className={`why-feature-cell ${idx < arr.length - 1 ? "why-feature-cell--border-right" : ""}`}>
                {feature.svgIcon ? (
                  <div dangerouslySetInnerHTML={{ __html: feature.svgIcon }} />
                ) : feature.icon ? (
                  typeof feature.icon === 'string' ? (
                    <span className="material-symbols-outlined why-feature-icon" style={{ fontSize: '32px', color: '#0F172A' }}>{feature.icon}</span>
                  ) : (
                    <span className="why-feature-icon isolate flex items-center justify-center text-[#0F172A]" style={{ width: '32px', height: '32px' }}>
                      {feature.icon}
                    </span>
                  )
                ) : null}
