export default function WorkingHours({ hours }) {
  return (
    <div className="working-hours">
      ...
      <a href="#" className="working-hours__cta">Make an Appointment</a>
    </div>
  );
}
