...
const featureCards = [
  {
    ...
    description: "Up to 8 shades brighter in a single session.",
    icon: (
  ...
  },
  {
    ...
    variant: "dark",
    title: "AI Precision",
    description: "3D scanning for perfect fitment.",
    icon: (
          ...
          <div className="smile-left-col">
            ...
            <div className="smile-comparison smile-comparison--large">
              <img
                ...
                src="https://api.builder.io/api/v1/image/assets/TEMP/2dcc9ab02d019e2def16edd48c9772e3adb33505?width=1342"
                alt="Before transformation"
              />
              <img
                className="smile-comparison__after"
                src="https://api.builder.io/api/v1/image/assets/TEMP/8173431904bb9d29f02185d64645d3cd940b066f?width=1120"
            ...
            <div className="smile-testimonial">
              ...
              <p className="smile-testimonial__quote">
                "I never thought my smile could look this natural and bright. The process was so easy and the results speak for themselves. Truly life-changing!"
              </p>
              <p className="smile-testimonial__author">— Michael R., Patient</p>
            </div>
          ...
          <div className="smile-right-col">
            ...
            <div className="smile-transformation-card">
              ...
              <div className="smile-comparison smile-comparison--small">
                <img
                  className="smile-comparison__before"
                  src="https://api.builder.io/api/v1/image/assets/TEMP/29a46dbad5dbfa3fd337571af87abf1ffb0d7696?width=1154"
                  alt="Before realignment"
                />
                <img
                  className="smile-comparison__after"
                  src="https://api.builder.io/api/v1/image/assets/TEMP/913fbff394341f7e25f96b22b41c322763ea7389?width=1136"
              ...
              <div className="smile-transformation-details">
                <h4 className="smile-transformation-title">Advanced Realignment</h4>
                <p className="smile-transformation-description">
                  Patient achieved perfect symmetry in just 14 months using our custom Invisalign plan.
                </p>
                <div className="smile-transformation-tags">
                  <span className="smile-tag smile-tag--yellow">14 MONTHS</span>
                  <span className="smile-tag smile-tag--grey">INVISALIGN</span>
                </div>
              </div>
            </div>
